...
function getErrorMessage(issue, index, options) {
    ...
    const {} = issue;
    const componentDelimeter = (0, _1.getComponentDelimiter)((_a = options === null || options === void 0 ? void 0 : options.delimiter) === null || _a === void 0 ? void 0 : _a.component);
    const labels = (0, _1.getComponentLabels)(options);
    const components = [];
    ...
    const pathString = (0, _1.getPathString)(issue.path, options === null || options === void 0 ? void 0 : options.path);
